...
import { Loader2, Users, TrendingUp, Wallet, Target, FileCheck } from "lucide-react"
...
export function PlatformOverview() {
  ...
  const { data: fundedProjects } = useQuery({
    queryKey: ["funded-projects-count"],
    queryFn: async () => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{fundedProjects || 0}</div>
            <p className="text-xs text-muted-foreground">
              المشاريع المكتملة التمويل
            </p>
          </CardContent>
        </Card>
      </div>
